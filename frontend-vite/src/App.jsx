  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* <Route path="/quiz/:id/questions" element={<AddEditQuestion />} /> */}
        {/* <Route path="/quiz/:id/questions" element={<AddEditQuestion />} /> */}
        {/* // Assuming you are using React Router */}
        {/* <Route path="/admin/exams/:examId/questions/add" element={<AddEditQuestion />} /> */}
        <Route path="/quiz/:quizId/questions" element={<AddEditQuestion />} />
        {/* <Route path="/quiz" element={<ExamsPage/>} /> */}
